...
import { requireRole, hasBrandAccess, NoBrandAccess, label, ProspectStatusForm, ProspectTouchLog } from "@keystone/admin-core";
  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs uppercase tracking-wide text-slate">{label(prospect.segment)}</span>
      </div>
